...
const hideGlobalTasksLabel = computed(() => hideGlobalTasks.value ? 'page.settings.card.questfilter.hide_global_tasks' : 'page.settings.card.questfilter.show_global_tasks')
const hideNonKappaTasksLabel = computed(() => hideNonKappaTasks.value ? 'page.settings.card.questfilter.hide_non_kappa_tasks' : 'page.settings.card.questfilter.show_non_kappa_tasks')
