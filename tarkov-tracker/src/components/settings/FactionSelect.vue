    ...
    <template #content>
      ...
      <v-container>
        <v-row justify="center">
          <v-col cols="12">
            <v-select v-model="currentPMCFaction" density="compact" :items="PMCFactions"
              :label="$t('page.settings.card.pmcfaction.select')" variant="outlined" hide-details :active="factionMenuActive">
