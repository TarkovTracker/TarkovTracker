...
.highlight-blue {
  background: linear-gradient(90deg, rgba(0, 0, 36, 0.15) 0%, rgba(0, 0, 121, 0.15) 35%, rgba(0, 0, 83, 0.15) 100%);
}

.highlight-red {
  background: linear-gradient(90deg, rgba(36, 0, 0, 0.15) 0%, rgba(121, 0, 0, 0.15) 35%, rgba(83, 0, 0, 0.15) 100%);
}

.highlight-tan {
  background: linear-gradient(90deg, rgba(36, 36, 0, 0.15) 0%, rgba(121, 121, 0, 0.15) 35%, rgba(83, 83, 0, 0.15) 100%);
}

.highlight-purple {
  background: linear-gradient(90deg, rgba(36, 0, 36, 0.15) 0%, rgba(121, 0, 121, 0.15) 35%, rgba(83, 0, 83, 0.15) 100%);
}

.highlight-accent {
  background: linear-gradient(135deg, rgba(29, 36, 38, 1) 0%, rgba(32, 46, 54, 1) 35%, rgba(35, 49, 56, 1) 100%);
}
